...
pdf(file = paste(myPath, 
                 "plots", 
                 "ProductGroup_chemOccurrence_upsetPlot_v2.pdf", sep = "/"), 
    width = 8, height = 6)
...
cat(paste("Unique products:", dim(prodList)[1],"\n"))
cat(paste("Tentative chemical hits (all products):",
          dim(subset(prodList,regexpr("SB",MySysID)==-1 &
                       Group=="xt"))))
