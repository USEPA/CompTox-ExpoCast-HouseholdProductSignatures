...
myPath <- "C:/Users/ZSTANFIE/OneDrive - Environmental Protection Agency (EPA)/zstanfield/HhldProdsNTA/HouseholdProdNTA"
...
curated <- read_xlsx("C:/Users/ZSTANFIE/OneDrive - Environmental Protection Agency (EPA)/zstanfield/HhldProdsNTA/xcxtChemsWithoutCCDmatch_TonyCurated.xlsx")
...
CFresult <- read.csv(file = "C:/Users/ZSTANFIE/OneDrive - Environmental Protection Agency (EPA)/zstanfield/HhldProdsNTA/houseProdNTA_chems_ClassyFire_batchquery_2023-12-07.csv")
# Remove any chemicals that couldn't be classified
CFresult <- CFresult[!CFresult$ClassyFy.Status == "Failed",]
# Match with curatedHPnta object to add chemical name, DTXSID, and CAS
ind <- match(CFresult$InChIKey, curatedHPnta$INCHIKEY)
CFresult <- cbind("DTXSID" = curatedHPnta$DTXSID[ind], "PREFERRED_NAME" = curatedHPnta$PREFERRED_NAME[ind], 
                  "CASRN" = curatedHPnta$CASRN[ind], CFresult)
...
#write.csv(sigCCD, file = "C:/Users/ZSTANFIE/OneDrive - Environmental Protection Agency (EPA)/zstanfield/HhldProdsNTA/signatureChemDTXSIDs_2023-11-08.txt",
